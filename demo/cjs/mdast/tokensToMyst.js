...
const defaultMdast = {
    ...
    figure: {
        ...
        getAttrs(token) {
            ...
            return Object.assign(Object.assign({ kind: 'figure' }, (0, utils_1.normalizeLabel)(name)), { numbered: name ? true : undefined, class: getClassName(token, [NUMBERED_CLASS]) });
        },
    },
    figure_caption: {
        type: 'caption',
    ...
    table: {
        ...
        getAttrs(token) {
            var _a, _b;
            const name = ((_a = token.meta) === null || _a === void 0 ? void 0 : _a.name) || undefined;
            return Object.assign(Object.assign({ kind: undefined }, (0, utils_1.normalizeLabel)(name)), { numbered: name ? true : undefined, class: getClassName(token, [NUMBERED_CLASS, ALIGN_CLASS]), align: ((_b = token.meta) === null || _b === void 0 ? void 0 : _b.align) || undefined });
        },
    },
    table_caption: {
        type: 'caption',
    ...
    math_block: {
        ...
        getAttrs(t) {
            ...
            return Object.assign({}, (0, utils_1.normalizeLabel)(name));
        },
    },
    math_block_label: {
        type: 'math',
    ...
    myst_target: {
        ...
        isLeaf: true,
        getAttrs(t) {
            return Object.assign({}, (0, utils_1.normalizeLabel)(t.content));
        },
    },
    html_inline: {
        type: 'html',
...
function tokensToMyst(tokens, options = defaultOptions) {
    ...
    tree = (0, unist_util_map_1.map)(tree, (node) => {
        var _a, _b;
    ...
    (0, unist_util_visit_1.visit)(tree, '_headerTarget', (node) => {
        const nextNode = (0, unist_util_find_after_1.findAfter)(tree, node);
        if (nextNode) {
            nextNode.identifier = node.identifier;
            nextNode.label = node.label;
        }
    });
    (0, unist_util_remove_1.remove)(tree, '_headerTarget');
    ...
    (0, unist_util_select_1.selectAll)('table', tree).map((node) => {
        var _a, _b;
